  ...
  return (
    <div className='footer'>
        ...
        <div className='github'>
            ...
            <NavLink className="nav-link" to="https://github.com/anatonokao">Alexander</NavLink>
            <NavLink className="nav-link" to="https://github.com/watashinokao">Darya</NavLink>
            <NavLink className="nav-link" to="https://github.com/Valeriy95">Valeriy</NavLink>
        </div>
        <div>
